...
## (https://interview.html5.wiki/section/15-设计模式.html#_1-创建型-工厂模式)1 创建型-工厂模式

------

### (https://interview.html5.wiki/section/15-设计模式.html#_1-1-简单工厂模式)1.1 简单工厂模式
...
### (https://interview.html5.wiki/section/15-设计模式.html#_1-2-抽象工厂模式)1.2 抽象工厂模式
...
## (https://interview.html5.wiki/section/15-设计模式.html#_2-创建型-单例模式)2 创建型-单例模式

------

> **保证一个类仅有一个实例，并提供一个访问它的全局访问点**，这样的模式就叫做单例模式。

### (https://interview.html5.wiki/section/15-设计模式.html#_2-1-单例模式的实现思路)2.1 单例模式的实现思路
...
### (https://interview.html5.wiki/section/15-设计模式.html#_2-2-生产实践-vuex中的单例模式)2.2 生产实践：Vuex中的单例模式
...
### (https://interview.html5.wiki/section/15-设计模式.html#_2-3-单例模式-面试真题)2.3 单例模式——面试真题
...
### (https://interview.html5.wiki/section/15-设计模式.html#_2-4-实现一个全局的模态框)2.4 实现一个全局的模态框
...
## (https://interview.html5.wiki/section/15-设计模式.html#_3-结构型-装饰器模式)3 结构型-装饰器模式

------

> 装饰器模式，又名装饰者模式。它的定义是“在不改变原对象的基础上，通过对其进行包装拓展，使原有对象可以满足用户的更复杂需求”。

### (https://interview.html5.wiki/section/15-设计模式.html#_3-1-装饰器模式初相见)3.1 装饰器模式初相见
...
### (https://interview.html5.wiki/section/15-设计模式.html#_3-2-深入装饰器原理)3.2 深入装饰器原理
...
### (https://interview.html5.wiki/section/15-设计模式.html#_3-3-装饰器语法糖背后的故事)3.3 装饰器语法糖背后的故事
...
### (https://interview.html5.wiki/section/15-设计模式.html#_3-4-将-属性描述对象-交到你手里)3.4 将“属性描述对象”交到你手里
...
### (https://interview.html5.wiki/section/15-设计模式.html#_3-5-react中的装饰器-hoc)3.5 React中的装饰器：HOC
...
### (https://interview.html5.wiki/section/15-设计模式.html#_3-6-使用装饰器改写-redux-connect)3.6 使用装饰器改写 Redux connect
...
## (https://interview.html5.wiki/section/15-设计模式.html#_4-结构型-适配器模式)4 结构型-适配器模式

------

### (https://interview.html5.wiki/section/15-设计模式.html#_4-1-兼容接口)4.1 兼容接口
...
### (https://interview.html5.wiki/section/15-设计模式.html#_4-2-生产实践-axios中的适配器)4.2 生产实践：axios中的适配器
...
## (https://interview.html5.wiki/section/15-设计模式.html#_5-结构型-代理模式)5 结构型-代理模式
...
### (https://interview.html5.wiki/section/15-设计模式.html#_5-1-es6中的proxy)5.1 ES6中的Proxy
...
### (https://interview.html5.wiki/section/15-设计模式.html#_5-2-婚介所-的实现)5.2 “婚介所”的实现
...
### (https://interview.html5.wiki/section/15-设计模式.html#_5-3-事件代理)5.3 事件代理
...
### (https://interview.html5.wiki/section/15-设计模式.html#_5-4-虚拟代理)5.4 虚拟代理
...
### (https://interview.html5.wiki/section/15-设计模式.html#_5-5-缓存代理)5.5 缓存代理
...
![img](https://interview.html5.wiki/image/20210629/125810.png)

> 我们发现 `proxyAddAll` 针对重复的入参只会计算一次，这将大大节省计算过程中的时间开销。现在我们有 6 个入参，可能还看不出来，当我们针对大量入参、做反复计算时，缓存代理的优势将得到更充分的凸显。

## (https://interview.html5.wiki/section/15-设计模式.html#_6-行为型-策略模式)6 行为型-策略模式
...
### (https://interview.html5.wiki/section/15-设计模式.html#_6-1-先来看一个真实场景)6.1 先来看一个真实场景
...
### (https://interview.html5.wiki/section/15-设计模式.html#_6-2-if-else-侠-人人喊打)6.2 if-else 侠，人人喊打
...
### (https://interview.html5.wiki/section/15-设计模式.html#_6-3-重构询价逻辑)6.3 重构询价逻辑
...
### (https://interview.html5.wiki/section/15-设计模式.html#_6-4-总结)6.4 总结
...
## (https://interview.html5.wiki/section/15-设计模式.html#_7-行为型-状态模式)7 行为型-状态模式

------

### (https://interview.html5.wiki/section/15-设计模式.html#_7-1-一台咖啡机的诞生)7.1 一台咖啡机的诞生
...
### (https://interview.html5.wiki/section/15-设计模式.html#_7-2-改造咖啡机的状态切换机制)7.2 改造咖啡机的状态切换机制
...
### (https://interview.html5.wiki/section/15-设计模式.html#_7-3-开放封闭)7.3 开放封闭
...
### (https://interview.html5.wiki/section/15-设计模式.html#_7-4-进一步改造)7.4 进一步改造
...
### (https://interview.html5.wiki/section/15-设计模式.html#_7-5-状态模式复盘)7.5 状态模式复盘
...
## (https://interview.html5.wiki/section/15-设计模式.html#_8-行为型-观察者模式)8 行为型-观察者模式
...
### (https://interview.html5.wiki/section/15-设计模式.html#_8-1-生活中的观察者模式)8.1 生活中的观察者模式
...
### (https://interview.html5.wiki/section/15-设计模式.html#_8-2-在实践中理解定义)8.2 在实践中理解定义
...
### (https://interview.html5.wiki/section/15-设计模式.html#_8-3-vue数据双向绑定-响应式系统-的实现原理)8.3 Vue数据双向绑定（响应式系统）的实现原理
...
![img](https://interview.html5.wiki/image/20210629/125834.png)
...
![img](https://interview.html5.wiki/image/20210629/125847.png)
...
### (https://interview.html5.wiki/section/15-设计模式.html#_8-4-实现一个event-bus-event-emitter)8.4 实现一个Event Bus / Event Emitter
...
### (https://interview.html5.wiki/section/15-设计模式.html#_8-5-观察者模式与发布-订阅模式的区别是什么)8.5 观察者模式与发布-订阅模式的区别是什么？
...
![img](https://interview.html5.wiki/image/20210629/125854.png)

**观察者模式**

![img](https://interview.html5.wiki/image/20210629/125858.png)
...
## (https://interview.html5.wiki/section/15-设计模式.html#_9-行为型-迭代器模式)9 行为型-迭代器模式
...
### (https://interview.html5.wiki/section/15-设计模式.html#_9-1-公元前-的迭代器模式)9.1 “公元前”的迭代器模式
...
![img](https://interview.html5.wiki/image/20210629/125910.png)
...
![img](https://interview.html5.wiki/image/20210629/125916.png)
...
![img](https://interview.html5.wiki/image/20210629/125922.png)

> 可以看出，`jQuery`的迭代器为我们统一了不同类型集合的遍历方式，使我们在访问集合内每一个成员时不用去关心集合本身的内部结构以及集合与集合间的差异，这就是迭代器存在的价值~

### (https://interview.html5.wiki/section/15-设计模式.html#_9-2-es6对迭代器的实现)9.2 ES6对迭代器的实现
...
![img](https://interview.html5.wiki/image/20210629/125927.png)
...
### (https://interview.html5.wiki/section/15-设计模式.html#_9-3-实现一个迭代器生成函数)9.3 实现一个迭代器生成函数
...
![img](https://interview.html5.wiki/image/20210629/125932.png)
...
![img](https://interview.html5.wiki/image/20210629/125937.png)
...
## (https://interview.html5.wiki/section/15-设计模式.html#_10-中介者模式)10 中介者模式
...
## (https://interview.html5.wiki/section/15-设计模式.html#_11-享元模式)11 享元模式
