...
![img](https://interview.html5.wiki/image/20210629/130248.png)

## (https://interview.html5.wiki/section/17-排序算法.html#冒泡排序)冒泡排序

------

> 通过相邻元素比较和交换，使得每一趟循环都能找到未排序的子数组。

### (https://interview.html5.wiki/section/17-排序算法.html#实现)实现
...
### (https://interview.html5.wiki/section/17-排序算法.html#优化)优化

#### (https://interview.html5.wiki/section/17-排序算法.html#单向冒泡)单向冒泡
...
#### (https://interview.html5.wiki/section/17-排序算法.html#双向冒泡)双向冒泡
...
## (https://interview.html5.wiki/section/17-排序算法.html#选择排序)选择排序

------

> 依次找到剩余元素的最小值或者最大值，放置末尾或者开头。

### (https://interview.html5.wiki/section/17-排序算法.html#实现-2)实现
...
## (https://interview.html5.wiki/section/17-排序算法.html#插入排序)插入排序

------

> 以第一个元素为有序数组，其后的元素通过在这个已有序的数组中找到合适的元素并插入。

### (https://interview.html5.wiki/section/17-排序算法.html#实现-3)实现
...
### (https://interview.html5.wiki/section/17-排序算法.html#优化-2)优化

#### (https://interview.html5.wiki/section/17-排序算法.html#拆半插入)拆半插入
...
## (https://interview.html5.wiki/section/17-排序算法.html#希尔排序)希尔排序
...
## (https://interview.html5.wiki/section/17-排序算法.html#归并排序)归并排序
...
## (https://interview.html5.wiki/section/17-排序算法.html#快速排序)快速排序
...
### (https://interview.html5.wiki/section/17-排序算法.html#实现一)实现一
...
### (https://interview.html5.wiki/section/17-排序算法.html#实现二)实现二
...
## (https://interview.html5.wiki/section/17-排序算法.html#堆排序)堆排序
...
### (https://interview.html5.wiki/section/17-排序算法.html#实现-4)实现
...
## (https://interview.html5.wiki/section/17-排序算法.html#计数排序)计数排序

------

> 以数组元素值为键，出现次数为值存进一个临时数组，最后再遍历这个临时数组还原回原数组。因为 JS 的数组下标是以字符串形式存储的，所以计数排序可以用来排列负数，但是不可以排列小数。

### (https://interview.html5.wiki/section/17-排序算法.html#实现-5)实现
...
## (https://interview.html5.wiki/section/17-排序算法.html#桶排序)桶排序
...
## (https://interview.html5.wiki/section/17-排序算法.html#基数排序)基数排序
