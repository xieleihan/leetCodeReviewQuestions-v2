...
## (https://interview.html5.wiki/section/18-计算机通识.html#一、网络)一、网络

------

### (https://interview.html5.wiki/section/18-计算机通识.html#_1-udp)1 UDP
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_2-tcp)2 TCP

**2.1 头部**

> `TCP` 头部比 `UDP` 头部复杂的多

![img](https://interview.html5.wiki/image/20210629/130313.png)
...
![img](https://interview.html5.wiki/image/20210629/130318.png)
...
![img](https://interview.html5.wiki/image/20210629/130328.png)
...
![img](https://interview.html5.wiki/image/20210629/130333.png)
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_3-http)3 HTTP
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_4-dns)4 DNS
...
## (https://interview.html5.wiki/section/18-计算机通识.html#二、数据结构)二、数据结构

------

### (https://interview.html5.wiki/section/18-计算机通识.html#_2-1-栈)2.1 栈
...
![img](https://interview.html5.wiki/image/20210629/130340.png)
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_2-2-队列)2.2 队列

**概念**

> 队列一个线性结构，特点是在某一端添加数据，在另一端删除数据，遵循先进先出的原则

![img](https://interview.html5.wiki/image/20210629/130344.png)
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_2-3-链表)2.3 链表

**概念**

> 链表是一个线性结构，同时也是一个天然的递归结构。链表结构可以充分利用计算机内存空间，实现灵活的内存动态管理。但是链表失去了数组随机读取的优点，同时链表由于增加了结点的指针域，空间开销比较大

![img](https://interview.html5.wiki/image/20210629/130351.png)
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_2-4-树)2.4 树
...
![img](https://interview.html5.wiki/image/20210629/130356.png)
...
![img](https://interview.html5.wiki/image/20210629/130401.png)
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_2-5-堆)2.5 堆
...
![img](https://interview.html5.wiki/image/20210629/130407.png)
...
## (https://interview.html5.wiki/section/18-计算机通识.html#三、算法)三、算法

------

### (https://interview.html5.wiki/section/18-计算机通识.html#_3-1-时间复杂度)3.1 时间复杂度
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_3-2-位运算)3.2 位运算
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_3-3-排序)3.3 排序

**冒泡排序**

> 冒泡排序的原理如下，从第一个元素开始，把当前元素和下一个索引元素进行比较。如果当前元素大，那么就交换位置，重复操作直到比较到最后一个元素，那么此时最后一个元素就是该数组中最大的数。下一轮重复以上操作，但是此时最后一个元素已经是最大数了，所以不需要再比较最后一个元素，只需要比较到 `length - 1` 的位置

![img](https://interview.html5.wiki/image/20210629/130414.png)
...
![img](https://interview.html5.wiki/image/20210629/130419.png)
...
![img](https://interview.html5.wiki/image/20210629/130511.gif)
...
![img](https://interview.html5.wiki/image/20210629/130519.gif)
...
![img](https://interview.html5.wiki/image/20210629/130526.gif)
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_3-4-链表)3.4 链表
...
### (https://interview.html5.wiki/section/18-计算机通识.html#_3-5-树)3.5 树
...
![img](https://interview.html5.wiki/image/20210629/130536.png)
