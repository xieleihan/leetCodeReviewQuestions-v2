...
## (https://interview.html5.wiki/#一、准备-简历编写和面试前准备)一、准备：简历编写和面试前准备
...
### (https://interview.html5.wiki/#准备一份合适的简历)准备一份合适的简历
...
### (https://interview.html5.wiki/#推荐使用-pdf-版本的简历)推荐使用 PDF 版本的简历
...
### (https://interview.html5.wiki/#简历最好要有针对性地来写)简历最好要有针对性地来写
...
### (https://interview.html5.wiki/#简历是面试时「点菜」用的菜单)简历是面试时「点菜」用的菜单
...
### (https://interview.html5.wiki/#拿到面试邀请之后做的准备工作)拿到面试邀请之后做的准备工作
...
### (https://interview.html5.wiki/#面试中出现的常规问题)面试中出现的常规问题
...
### (https://interview.html5.wiki/#利用脑图来梳理知识点)利用脑图来梳理知识点
...
## (https://interview.html5.wiki/#二、-一面-1-基础知识点与高频考题解析)二、 一面 1：基础知识点与高频考题解析

------

> `JavaScript` 是 `ECMAScript` 规范的一种实现，本小节重点梳理下 `ECMAScript` 中的常考知识点，然后就一些容易出现的题目进行解析。

### (https://interview.html5.wiki/#知识点梳理)知识点梳理
...
### (https://interview.html5.wiki/#变量类型)变量类型
...
### (https://interview.html5.wiki/#typeof)`typeof`
...
### (https://interview.html5.wiki/#instanceof)`instanceof`
...
### (https://interview.html5.wiki/#值类型-vs-引用类型)值类型 vs 引用类型
...
### (https://interview.html5.wiki/#原型和原型链)原型和原型链
...
### (https://interview.html5.wiki/#执行上下文)执行上下文
...
### (https://interview.html5.wiki/#this)`this`
...
### (https://interview.html5.wiki/#作用域)作用域
...
### (https://interview.html5.wiki/#作用域链)作用域链
...
### (https://interview.html5.wiki/#闭包)闭包
...
### (https://interview.html5.wiki/#异步)异步
...
### (https://interview.html5.wiki/#es6-7-新标准的考查)ES6/7 新标准的考查
...
### (https://interview.html5.wiki/#set-和-map)Set 和 Map
...
### (https://interview.html5.wiki/#promise)Promise
...
关于 ES6/7 的考查内容还有很多，本小节就不逐一介绍了，如果想继续深入学习，可以在线看《[ES6入门 (opens new window) (opens new window)](http://es6.ruanyifeng.com/)》。

## (https://interview.html5.wiki/#三、一面-2-js-web-api-知识点与高频考题解析)三、一面 2：JS-Web-API 知识点与高频考题解析

------

> 除 ES 基础之外，Web 前端经常会用到一些跟浏览器相关的 API，接下来我们一起梳理一下。

### (https://interview.html5.wiki/#知识点梳理-2)知识点梳理
...
### (https://interview.html5.wiki/#bom)BOM
...
### (https://interview.html5.wiki/#dom)DOM
...
![img](https://interview.html5.wiki/image/20210629/163143.png)
...
### (https://interview.html5.wiki/#事件)事件
...
### (https://interview.html5.wiki/#ajax)Ajax
...
> 目前已经有一个获取 HTTP 请求更加方便的 API：`Fetch`，通过`Fetch`提供的`fetch()`这个全局函数方法可以很简单地发起异步请求，并且支持`Promise`的回调。但是 Fetch API 是比较新的 API，具体使用的时候还需要查查 [caniuse (opens new window) (opens new window)](https://caniuse.com/)，看下其浏览器兼容情况。
...
### (https://interview.html5.wiki/#跨域)跨域
...
### (https://interview.html5.wiki/#存储)存储
...
### (https://interview.html5.wiki/#小结)小结

> 本小节总结了 W3C 标准中 `Web-API` 部分，面试中常考的知识点，这些也是日常开发中最常用的 API 和知识。

## (https://interview.html5.wiki/#四、一面-3-css-html-知识点与高频考题解析)四、一面 3：CSS-HTML 知识点与高频考题解析

------

> `CSS` 和 `HTML` 是网页开发中布局相关的组成部分，涉及的内容比较多和杂乱，本小节重点介绍下常考的知识点。

### (https://interview.html5.wiki/#知识点梳理-3)知识点梳理
...
### (https://interview.html5.wiki/#选择器的权重和优先级)选择器的权重和优先级
...
### (https://interview.html5.wiki/#盒模型)盒模型
...
![img](https://interview.html5.wiki/image/20210629/163153.png)
...
![img](https://interview.html5.wiki/image/20210629/163158.png)
...
![img](https://interview.html5.wiki/image/20210629/163203.png)
...
![img](https://interview.html5.wiki/image/20210629/163211.png)
...
![img](https://interview.html5.wiki/image/20210629/163216.png)
...
### (https://interview.html5.wiki/#浮动float)浮动`float`
...
![img](https://interview.html5.wiki/image/20210629/163222.png)
...
![img](https://interview.html5.wiki/image/20210629/163229.png)
...
![img](https://interview.html5.wiki/image/20210629/163233.png)

> 加上`float:left`之后：

![img](https://interview.html5.wiki/image/20210629/163239.png)
...
> float 的设计初衷是解决文字环绕图片的问题，后来误打误撞用于做布局，因此有许多不合适或者需要注意的地方，上文基本都讲到了需要的知识点。如果是刚开始接触 float 的同学，学完上面的基础知识之后，还应该做一些练习实战一下 —— 经典的“圣杯布局”和“双飞翼布局”。这里就不再展开讲了，网上资料非常多，例如[浅谈面试中常考的两种经典布局——圣杯与双飞翼 (opens new window) (opens new window)](https://juejin.im/entry/5a8868cdf265da4e7e10c133?utm_source=gold_browser_extension)（此文的最后两张图清晰地展示了这两种布局）。

### (https://interview.html5.wiki/#定位-position)定位 position
...
![img](https://interview.html5.wiki/image/20210629/163255.png)
...
![img](https://interview.html5.wiki/image/20210629/163301.png)
...
![img](https://interview.html5.wiki/image/20210629/163306.png)
...
![img](https://interview.html5.wiki/image/20210629/163313.png)

> 然后，我们把第三个`<p>`改为`position:absolute;`，看看会发生什么变化。

![img](https://interview.html5.wiki/image/20210629/163318.png)
...
![img](https://interview.html5.wiki/image/20210629/163323.png)

> `fixed` 元素的定位是相对于 `window` （或者 `iframe`）边界的，和其他元素没有关系。但是它具有破坏性，会导致其他元素位置的变化。

![img](https://interview.html5.wiki/image/20210629/163328.png)
...
![img](https://interview.html5.wiki/image/20210629/163335.png) ![img](https://interview.html5.wiki/image/20210629/163340.png)

### (https://interview.html5.wiki/#flex布局)flex布局
...
![img](https://interview.html5.wiki/image/20210629/163347.png)
...
![img](https://interview.html5.wiki/image/20210629/163352.png)
...
![img](https://interview.html5.wiki/image/20210629/163358.png)
...
![img](https://interview.html5.wiki/image/20210629/163405.png)
...
![img](https://interview.html5.wiki/image/20210629/163411.png)

### (https://interview.html5.wiki/#如何实现居中对齐)如何实现居中对齐？
...
### (https://interview.html5.wiki/#理解语义化)理解语义化
...
### (https://interview.html5.wiki/#css3-动画)CSS3 动画
...
### (https://interview.html5.wiki/#重绘和回流)重绘和回流
...
### (https://interview.html5.wiki/#数据结构)数据结构
...
### (https://interview.html5.wiki/#前端常遇见的数据结构问题)前端常遇见的数据结构问题
...
### (https://interview.html5.wiki/#算法的效率是通过算法复杂度来衡量的)算法的效率是通过算法复杂度来衡量的
...
### (https://interview.html5.wiki/#人人都要掌握的基础算法)人人都要掌握的基础算法
...
### (https://interview.html5.wiki/#快排和二分查找)快排和二分查找
...
### (https://interview.html5.wiki/#面试遇见不会的算法问题怎么办)面试遇见不会的算法问题怎么办
...
### (https://interview.html5.wiki/#正则匹配解题)正则匹配解题
...
> 对于零宽断言的详细介绍可以阅读「[零宽断言 (opens new window) (opens new window)](https://deerchao.net/tutorials/regex/regex.htm#lookaround)」这篇文章。
...
### (https://interview.html5.wiki/#小结-3)小结
...
## (https://interview.html5.wiki/#六、一面-5-浏览器相关知识点与高频考题解析)六、一面 5：浏览器相关知识点与高频考题解析

------

> `Web` 前端工程师写的页面要跑在浏览器里面，所以面试中也会出现很多跟浏览器相关的面试题目。

### (https://interview.html5.wiki/#知识点梳理-5)知识点梳理
...
### (https://interview.html5.wiki/#加载页面和渲染过程)加载页面和渲染过程
...
![img](https://interview.html5.wiki/image/20210629/163425.png)
...
> 关于浏览器整个流程，百度的多益大神有更加详细的文章，推荐阅读下：《[从输入 URL 到页面加载完成的过程中都发生了什么事情？ (opens new window) (opens new window)](http://fex.baidu.com/blog/2014/05/what-happen/)》。

### (https://interview.html5.wiki/#性能优化)性能优化
...
### (https://interview.html5.wiki/#详细解释)详细解释
...
### (https://interview.html5.wiki/#web-安全)Web 安全
...
## (https://interview.html5.wiki/#七、一面-6-开发环境相关知识点与高频考题解析)七、一面 6：开发环境相关知识点与高频考题解析

------

### (https://interview.html5.wiki/#知识点梳理-6)知识点梳理
...
### (https://interview.html5.wiki/#ide)IDE

> 题目：你平时都使用什么 IDE 编程？有何提高效率的方法？

- 前端最常用的 IDE 有 [Webstorm (opens new window) (opens new window)](https://www.jetbrains.com/webstorm/)、[Sublime (opens new window) (opens new window)](https://www.sublimetext.com/)、[Atom (opens new window) (opens new window)](https://atom.io/)和 [VSCode (opens new window) (opens new window)](https://code.visualstudio.com/)，我们可以分别去它们的官网看一下。
...
### (https://interview.html5.wiki/#git)Git

- 你此前做过的项目一定要用过 Git，而且必须是命令行，如果没用过，你自己也得恶补一下。对 Git 的基本应用比较熟悉的同学，可以跳过这一部分了。macOS 自带 Git，Windows 需要安装 Git 客户端，去 [Git 官网 (opens new window) (opens new window)](https://git-scm.com/download/win)下载即可。
...
### (https://interview.html5.wiki/#关于-svn)关于 SVN
...
### (https://interview.html5.wiki/#linux-基础命令)Linux 基础命令
...
### (https://interview.html5.wiki/#前端构建工具)前端构建工具
...
- 最早普及使用的构建工具是 [Grunt (opens new window) (opens new window)](http://www.gruntjs.net/)，不久又被 [Gulp (opens new window) (opens new window)](https://www.gulpjs.com.cn/)给追赶上。Gulp 因其简单的配置以及高效的性能而被大家所接受，也是笔者个人比较推荐的构建工具之一。如果你做一些简单的 JS 开发，可以考虑使用。
...
- 首先，你需要安装 Node.js，没有安装的可以去 [Node.js 官网 (opens new window) (opens new window)](http://nodejs.cn/download/)下载并安装。安装完成后运行如下命令来验证是否安装成功。
...
### (https://interview.html5.wiki/#调试方法)调试方法
...
- 针对移动端的抓包工具，Mac 系统下推荐使用 Charles 这个工具，首先 [下载 (opens new window) (opens new window)](https://www.charlesproxy.com/download/)并安装，打开。Windows 系统推荐使用 [Fiddler (opens new window) (opens new window)](http://rj.baidu.com/soft/detail/10963.html)，下载安装打开。两者使用基本一致，下面以 Charles 为例介绍。
...
![img](https://interview.html5.wiki/image/20210629/163442.png)

### (https://interview.html5.wiki/#小结-4)小结

> 本小节总结了前端开发环境常考查的知识，这些知识也是前端程序员必须掌握的，否则会影响开发效率。

## (https://interview.html5.wiki/#八、二面-1-如何回答常见的软技能问题)八、二面 1：如何回答常见的软技能问题

------

> 面试是个技术活，不仅仅是技术，各种软技能的面试技巧也是非常重要的，尤其是程序员一般对于自己的软技能不是很看重，其实**软技能才是决定你职场能够走多远的关键**。

### (https://interview.html5.wiki/#程序员应该具备的软技能)程序员应该具备的软技能
...
### (https://interview.html5.wiki/#常见的软技能问题和提升)常见的软技能问题和提升
...
### (https://interview.html5.wiki/#小结-5)小结

本小节介绍了程序员除了业务技术能力之外应该日常修炼的软技能，在面试中，软技能会被以各种形式问起，候选人应该先了解有哪些软技能可以修炼，才能在回答软技能问题的时候，尽量提到自己具备的软技能。

## (https://interview.html5.wiki/#九、二面-2-如何介绍项目及应对项目细节追问)九、二面 2：如何介绍项目及应对项目细节追问
...
### (https://interview.html5.wiki/#怎样介绍自己做过的一个项目)怎样介绍自己做过的一个项目
...
### (https://interview.html5.wiki/#没有做过大型项目怎么办)没有做过大型项目怎么办
...
### (https://interview.html5.wiki/#项目细节和技术点的追问)项目细节和技术点的追问
...
### (https://interview.html5.wiki/#匹配度考查)匹配度考查
...
### (https://interview.html5.wiki/#谈薪资)谈薪资
...
### (https://interview.html5.wiki/#准确定位和自我估值)准确定位和自我估值
...
> [如何在跳槽前客观地评估自己的身价？ (opens new window)(opens new window)](https://www.zhihu.com/question/28313219/answer/331599918)

### (https://interview.html5.wiki/#跟-hr-沟通的技巧)跟 HR 沟通的技巧
...
## (https://interview.html5.wiki/#十一、其他-面试注意事项)十一、其他：面试注意事项

------

> 除了前面小节中提到的一些面试中应该注意的问题，本小节再整理一些面试中应该注意的事项。

### (https://interview.html5.wiki/#注意社交礼仪)注意社交礼仪

虽然说 IT 行业不怎么注重工作环境，上下级也没有繁文缛节，但是在面试中还是应该注意一些社交礼仪的。像进门敲门、出门关门、站着迎人这类基本礼仪还是要做的。

### (https://interview.html5.wiki/#舒适但不随意的着装)舒适但不随意的着装

首先着装方面，不要太随意，也不要太正式，太正式的衣服可能会使人紧张，所以建议穿自己平时喜欢的衣服，关键是干净整洁。

### (https://interview.html5.wiki/#约个双方都舒服的面试时间)约个双方都舒服的面试时间
...
### (https://interview.html5.wiki/#面试后的提问环节)面试后的提问环节
...
### (https://interview.html5.wiki/#面试禁忌)面试禁忌
...
### (https://interview.html5.wiki/#最好自己带电脑)最好自己带电脑
...
### (https://interview.html5.wiki/#面试后的总结和思考)面试后的总结和思考
...
## (https://interview.html5.wiki/#十二、总结)十二、总结

------

### (https://interview.html5.wiki/#准备阶段)准备阶段
...
### (https://interview.html5.wiki/#技术面部分)技术面部分

> 集中梳理了 ECMAScript 基础、JS-Web-API、CSS 和 HTML、算法、浏览器和开发环境六大部分内容，并且就一些高频考题进行讲解。

### (https://interview.html5.wiki/#非技术面试部分)非技术面试部分
...
### (https://interview.html5.wiki/#hr-面)HR 面
...
### (https://interview.html5.wiki/#补充说明)补充说明
...
### (https://interview.html5.wiki/#node-js部分)Node.js部分
...
### (https://interview.html5.wiki/#前端框架-库)前端框架（库）
...
### (https://interview.html5.wiki/#移动开发)移动开发
